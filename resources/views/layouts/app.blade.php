                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            @foreach (Auth::user()->load('courses')->courses as $course)
                                                <a href="{{ route('student-responses.index') }}"
                                                    class="dropdown-item text-uppercase">{{ $course->course_name }}</a>
                                            @endforeach
                                        </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a href="/show-result" class="nav-link">Result</a>
                                </li>
                            @endcan
